...
const DeleteConfirmation = ({ onLogout, onCancel }) => {
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-stone-800 text-white p-6 rounded-lg shadow-md max-w-md">
                <h2 className="text-xl font-bold font-nunito mb-4">Delete Confirmation</h2>
                <p className="mb-6 text-sm font-nunito">Are you sure you want to delete?</p>
